...
def load_api():
    ...
    consumer_key = 'mS73i40yn5BV7drKSQuKhDX7s'
    consumer_secret = 'vVNjoRaMJiM9HpltYIjYwrbwj9ci1L6uZlpc6C5BkAZSP1YrAk'
    access_token = '360659405-StWexA1Ybdb2cK4d8tug5xWn4iXoLRiIYpDQaJDV'
    access_secret = 'TpVEk0M4kMJASUkKSaWNQJxqlQkvg7jQtCeaS6XmvcnK3'
...
def main():
    ...
    ''' search variables: '''
    search_phrases = ['Dev_Rajath',]
    min_days_old, max_days_old = 1, 8          # search limits e.g., from 7 to 8
                                               # gives current weekday from last week,
                                               # min_days_old=0 will search from right now
    INDIA = '28.5275198,77.068899,2500km'       # this geocode includes nearly all American
    ...
    for search_phrase in search_phrases:
        ...
        while dt.datetime.now() < end:
            ...
            tweets, max_id = tweet_search(api, search_phrase, 100,
